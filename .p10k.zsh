# Generated by Powerlevel10k configuration wizard on 2026-03-14 at 16:36 CDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND='#0e0e0e'
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND='#0e0e0e'
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='#0e0e0e'
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND='#0e0e0e'
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND='#0e0e0e'
  ...
  function my_git_formatter() {
    ...
    local  untracked='%9F' # black foreground
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND='#181818'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND='#181818'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND='#181818'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND='#181818'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND='#181818'
  ...
  # element in each pair defines a pattern against which xclip -sel clip < the current kubernetes context gets
