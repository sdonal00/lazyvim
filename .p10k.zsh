# Generated by Powerlevel10k configuration wizard on 2026-06-17 at 01:24 UTC.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#a0a8b7'
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#a0a8b7'
  ...
  typeset -g POWERLEVEL9K_RVM_CONTENT_EXPANSION='[${P9K_CONTENT}]'
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND='#a0a8b7'
